    ...
    <div className={`h-screen bg-white p-4 pt-8 font-Poppins  linesB`}>
      <div className="text-[#0A090C] flex relative ">
        <button
          ...
          className="absolute font-Poppins border border-black flex items-center justify-center text-xs hover:border-white duration-300 -right-1 top-14 p-2 z-30 border-black"
        >
          TimeLine
        </button>
      </div>
